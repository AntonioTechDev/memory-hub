...
|---|---:|---|
| Accuracy | 5/5 | 98/98 tests pass with resource warnings fatal; the real incident replay classifies 73/73 historical validations and preserves 3/31 true scope violations. |
...
| Actionability | 5/5 | Version 0.5.1 is installed locally, the additive schema remains backward-compatible, active runs are zero, and the same installer remains portable. |
